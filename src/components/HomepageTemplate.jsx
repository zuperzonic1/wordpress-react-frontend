    ...
    <div>
      <div className="mb-4 p-4 bg-white border border-gray-200 rounded-lg shadow-lg flex flex-col md:flex-row items-center">
        <img
          ...
          alt="Featured"
          className="md:w-1/2 rounded-lg mb-4 md:mb-0 md:mr-4"
        />
        <div>
          ...
          <p className="font-normal text-gray-700 dark:text-gray-400">
            Explore our features and learn more about what we offer. Our site
            provides comprehensive insights and tools to help you succeed.
          </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="p-4 bg-white border border-gray-200 rounded-lg shadow-lg">
          ...
          <p className="text-sm text-gray-700 dark:text-gray-400">
            Detailed information about this section. Discover the features and
            benefits that make our services unique and effective.
          </p>
          <button className="mt-3 px-4 py-2 bg-white-500 border text-black rounded hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-opacity-50">
            Explore
          </button>
